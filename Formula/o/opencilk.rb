class Opencilk < Formula
  ...
  conflicts_with "llvm@12", because: "both provide `clang` binaries"
  conflicts_with "llvm@13", because: "both provide `clang` binaries"
  conflicts_with "llvm@14", because: "both provide `clang` binaries"
  conflicts_with "llvm@15", because: "both provide `clang` binaries"
  conflicts_with "llvm@16", because: "both provide `clang` binaries"
  conflicts_with "llvm@17", because: "both provide `clang` binaries"
  conflicts_with "llvm@18", because: "both provide `clang` binaries"
  conflicts_with "llvm@19", because: "both provide `clang` binaries"
  conflicts_with "llvm", because: "both provide `clang` binaries"
